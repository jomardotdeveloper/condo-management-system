<ul class="nk-menu">
    ...
    <li class="nk-menu-item">
        <a href="#" class="nk-menu-link">
            ...
            <span class="nk-menu-text">Pull outs</span>
        </a>
    </li>
    <li class="nk-menu-item">
        <a href="#" class="nk-menu-link">
    ...
    <li class="nk-menu-item has-sub">
        ...
        <ul class="nk-menu-sub">
            <li class="nk-menu-item">
                <a href="#" class="nk-menu-link"><span class="nk-menu-text">Accounts</span></a>
            </li>
            <li class="nk-menu-item">
                <a href="#" class="nk-menu-link"><span class="nk-menu-text">Cash Flow</span></a>
            </li>
        </ul>
    </li>
    <li class="nk-menu-item">
